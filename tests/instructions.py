...
`sys.monitoring` turns off the specialisation of the interpreter while
...
def count_instructions(work) -> int:
    ...
    of ptterm and of the standard library under it. It does not hold
    the work of a C extension, which runs no bytecode.
    """
    counted = 0
